...
export function HomeCards() {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      {/* Other — intentionally a disabled placeholder */}
      <button
        type="button"
        disabled
        aria-disabled="true"
      ...
      >
        ...
        <div className="mt-5">
          <div className="flex items-center gap-2">
            ...
            <span className="rounded border border-hair px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-wider text-faint">
              soon
            </span>
          </div>
          <p className="mt-1.5 text-sm leading-relaxed text-muted">Currently in development.</p>
        </div>
