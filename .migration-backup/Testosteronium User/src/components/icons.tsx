...
/**
 * Inline SVG icons — no external icon library, kept on-brand (1.6 stroke,
 * currentColor) so they inherit the panel's text color.
 */
...
export function TicketIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M3 8.5V7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v1.5a1.8 1.8 0 0 0 0 3V15a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1.5a1.8 1.8 0 0 0 0-3Z" />
